...
| Fleet portal | (own rail) | `/fleet-portal/*` — roster (+ `/drivers/[id]` profile), issues, documents, scorecard, payouts, support | FLEET role, fenced |
