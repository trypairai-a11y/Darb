// Phase 6 Wave 2b — DeliverooScraperAdapter (Phase 11 deferral)
//
// Deliveroo has no public ops portal scraping yet (orchestrator resolution:
// scraper deferred to Phase 11 — REQ-ingest-partner-api-conversations). This
// adapter is a deliberate NotAvailable stub: it occupies the precedence slot
// so the CompositeAdapter chain remains explicit, but every fetch* throws
...
const DEFERRED =
  "Deliveroo scraper deferred to Phase 11 (REQ-ingest-partner-api-conversations)";

export class DeliverooScraperAdapter implements IngestAdapter {
