// Phase 6 Wave 2b — TalabatOcrAdapter
//
// Thin façade around the existing /api/talabat/metrics/ingest-screenshot
// route (backend/src/routes/talabat.ts). OCR is request-driven (mobile-app
...
// source for Talabat (REQ-ingest-adapter-layer's intent: enumerate every
...
const REQUEST_DRIVEN =
  "Talabat OCR is request-driven (POST /api/talabat/metrics/ingest-screenshot); no date-range pull";
