"use client";
// Revision 20 — the live control room, lifted out of app/(dashboard)/ops/page.tsx
// so the Ops tab can host it alongside its seven sibling subtabs.
//
// Nothing about the screen changed in the move. It is still the same four
// segments (?view=orders|drivers|problems|areas), the same map, the same
// OrderOpsPanel, and /ops with no query still opens it — which is what keeps
// every bookmark, notification link and muscle memory working.
