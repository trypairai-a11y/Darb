...
export default function TicketsPage() {
  ...
  return (
    <div className="space-y-10 w-full max-w-none">
      ...
      {showNewModal && (
        <div
          className="fixed inset-0 bg-forest-900/25 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in"
        ...
        {selectedTicket && (
          <div className="space-y-6">
            ...
            {selectedTicket.status === "RESOLVED" && selectedTicket.resolution && !resolveOpen && (
              <div className="rounded-xl border border-forest-200 bg-forest-50/50 dark:bg-forest-900/10 p-4 space-y-1.5">
                <p className="text-[11px] uppercase tracking-[0.12em] font-medium text-forest-700">
                  {t("tickets.resolutionNote")}
                </p>
