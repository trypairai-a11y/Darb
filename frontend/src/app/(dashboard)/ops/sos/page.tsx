"use client";
// Darb 2.0 — /ops/sos: incident console. OPEN incidents render as red cards
// (driver, order, category, live elapsed, mini map, photos); the sound alert
// loops while any OPEN incident is un-acknowledged (Web Audio, gesture-
// unlocked). SSE sos.raised/incident.updated + a 10s polling backstop.
import { useEffect, useMemo, useState } from "react";
import { useQuery, useQueryClient } from "@tanstack/react-query";
import { BellOff, BellRing, Check, MousePointerClick, Phone } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <h1 className="font-display text-display-sm text-sand-900">{t("opsPages.sosTitle")}</h1>
