...
export interface Messages {
  ...
  common: {
    ...
    cancel: string;
    save: string;
    /** Revision 20 — the row-level "open this record" link. */
    view: string;
    /** Used by /requests and the fleet detail panel, which call them
     *  on `common`; `labels` has its own copies for other screens. */
    approve: string;
    reject: string;
    confirm: string;
    delete: string;
  ...
  errors: {
    ...
    noData: string;
    loadingData: string;
    /** Revision 20 — the counterpart of loadingData, for a failed write. */
    savingData: string;
...
export const en: Messages = {
  ...
  errors: {
    ...
    savingData: "That could not be saved. Try again.",
    notFound: "Not found",
    noData: "No data",
    loadingData: "Loading...",
  ...
  hq: {
    ...
    admin: "Admin",
    opsTitle: "Operations",
    opsSubtitle: "The floor, the people on it, and who is joining next.",
    tabLive: "Live",
    tabOrders: "Orders",
    tabEquipment: "Equipment",
    tabZones: "Areas",
    tabDriverTracking: "Driver tracking",
  ...
  driverTracking: {
    ...
    subtitle: "How every driver is performing, and the switches that decide whether they work.",
    ...
    freeze: "Freeze",
    unfreeze: "Unfreeze",
    sendToTraining: "Send for training",
    frozen: "Frozen",
    inTraining: "In training",
    freezeReason: "Why are you freezing this driver?",
    freezeReasonHint: "The driver and the delivery company both see this.",
    trainingPeriod: "Training period",
    days: "{n} days",
    oneDay: "1 day",
    trainingReason: "Why are you sending them for training?",
    sent: "Sent for training",
    stateSaved: "Driver updated",
  ...
  shiftPlan: {
    ...
    subtitle: "A proposal built from what actually happened, for you to change and approve.",
    weekOf: "Week of {date}",
    generate: "Generate a proposal",
    regenerate: "Build it again",
    approve: "Approve the plan",
    discard: "Discard",
    statusDraft: "Draft",
    statusApproved: "Approved",
    statusDiscarded: "Discarded",
    noPlan: "No proposal for this week yet.",
    noPlanHint: "Generate one and Darb will read the past weeks to suggest how many drivers each window needs.",
    basis: "How this was worked out",
    proposed: "Proposed",
    approved: "Approved",
    demand: "Orders in the past weeks",
    zone: "Area",
    window: "Window",
    save: "Save changes",
    saved: "Plan saved",
    approvedToast: "Plan approved. The driver app books against it now.",
    approveWarning: "Approving replaces the whole capacity grid the driver app books against.",
    approvedBy: "Approved by {name}",
    suggestedDrivers: "Suggested drivers",
    noSuggestions: "No drivers assigned to this area yet.",
    readOnly: "This week is approved. Generate a new proposal to change it.",
    weekAlreadyApproved: "That week has already been approved.",
  ...
  driverTraining: {
    ...
    subtitle: "Practice orders a trainee delivers for real, watched by you, with no money moving.",
    newSession: "Start a training window",
    ...
    period: "Period",
    changePeriod: "Change the period",
    ends: "Ends {date}",
    issueOrder: "Give a practice order",
    pickupPoint: "Collect from",
    dropoffAddress: "Deliver to",
    customerName: "Customer name",
    minutes: "Minutes allowed",
    orders: "Practice orders",
    noOrders: "No practice orders yet.",
    assigned: "Given",
    ...
    podRate: "Proof attached",
    pass: "Activate the account",
    fail: "Did not pass",
    cancel: "Call it off",
    outcomeNote: "Anything to note?",
    passHint: "Passing activates the driver, and dispatch starts offering them real orders.",
    failHint: "They stay inactive until somebody activates them.",
    empty: "No training windows yet.",
    started: "Training window opened",
    orderIssued: "Practice order given",
    periodSaved: "Period updated",
    completed: "Training window closed",
    practiceBadge: "Practice",
    moneyNote: "Practice orders never reach the ledger, the shop's board, or the delivery company's payout.",
    start: "Start now",
    selectDriver: "Driver",
  ...
  hqOnboarding: {
    title: "New accounts",
    subtitle: "Shops and delivery companies the sales team has signed, waiting to be set up.",
    add: "Add a request",
    typeVendor: "Shop",
    typeFleet: "Delivery company",
    companyName: "Company name",
    companyNameAr: "Name in Arabic",
    code: "Short code",
    codeHint: "Goes into every order number for this shop. Letters and digits, 2 to 8.",
    contactName: "Contact",
    contactPhone: "Phone",
    contactEmail: "Email",
    ...
    reject: "Reject",
    rejectReason: "Why is this being rejected?",
    approveHint: "Approving creates the account. Nothing exists until you do.",
    created: "Request added",
    approvedToast: "Account created",
    rejectedToast: "Request rejected",
    empty: "Nothing waiting.",
    openAccount: "Open the account",
    raisedBy: "Raised by {name}",
    codeInUse: "That code is already in use. Pick another.",
    allTypes: "Shops and companies",
  },
  compliance: {
    title: "Compliance",
    subtitle: "The paperwork behind every driver, shop and delivery company on the network.",
    tabDriverDocs: "Driver documents",
    tabRenewals: "Renewal schedule",
    tabPartnerDocs: "Shop and company documents",
    autoPass: "Checked, nothing flagged",
    autoFlag: "Flagged by the check",
    autoPending: "Not checked yet",
    recheck: "Run the check again",
    approve: "Approve",
    reject: "Reject",
    rejectReason: "Why is this being rejected?",
    rejectHint: "The delivery company sees this word for word.",
    requestDocument: "Ask for a document",
    requestNote: "What do you need, and why?",
    requestSent: "Request sent",
    statusREQUESTED: "Asked for",
    statusPENDING_REVIEW: "Waiting on you",
    statusVALID: "Valid",
    statusREJECTED: "Rejected",
    ...
    viewFile: "Open the file",
    flaggedOnly: "Only flagged",
    empty: "Nothing here.",
    approved: "Document approved",
    rejected: "Document rejected",
    healthEXPIRED: "Expired",
    healthEXPIRING: "Expiring",
    healthVALID: "Valid",
    ...
    unfreeze: "Unfreeze",
    freezeReason: "Why is this account being frozen?",
    freezeHintDriver: "A frozen driver stops receiving orders straight away.",
    freezeHintPartner: "A frozen account stays frozen until compliance lifts it. Its own people cannot.",
    frozen: "Frozen",
    ...
    scopeDRIVER: "Driver",
    scopeCOMPANY: "Delivery company",
    scopeVENDOR: "Shop",
    checkNO_FILE: "No scan attached",
    checkNO_EXPIRY: "No expiry date given",
    checkALREADY_EXPIRED: "Already expired",
    checkEXPIRES_SOON: "Expires within 30 days",
    checkEXPIRY_IMPLAUSIBLE: "The expiry date looks wrong",
    checkUNKNOWN_TYPE: "Document type not recognised",
    checkTYPE_MISMATCH: "Wrong document type for this owner",
    checkFILE_TOO_SMALL: "The file is too small to read",
    checkFILE_TOO_LARGE: "The file is too large",
    checkUNSUPPORTED_FORMAT: "Not a document scan format",
    checkDUPLICATE_PENDING: "Another of the same type is already waiting",
    permissionDenied: "You do not have access to the compliance desk.",
  },
  financeDesk: {
    ...
    account: "Account",
    kindVENDOR_TOP_UP: "Shop top-up",
    kindFLEET_DEPOSIT: "Company deposit",
    amount: "Amount",
    reference: "Reference",
    requested: "Requested",
    confirm: "Confirm it arrived",
    cancelPayment: "Cancel it",
    rejectPayment: "Reject it",
    rejectReason: "Why is this being rejected?",
    confirmed: "Payment confirmed",
    cancelled: "Payment cancelled",
    alreadyPaid: "That payment was already confirmed.",
    noPayments: "Nothing waiting.",
    showAll: "All payments",
    showPending: "Waiting",
    sideAll: "Shops and companies",
    sideVendor: "Shops",
    sideFleet: "Delivery companies",
    disputesTitle: "Disputes",
    disputesSubtitle: "Where a shop or a delivery company disagrees with us about money.",
    disputedStatement: "Disputed payout",
    period: "Period",
    reason: "Their reason",
    openStatement: "Open the statement",
    noDisputes: "No open disputes.",
    reply: "Reply",
    replyPlaceholder: "Write back to them",
    send: "Send",
  ...
  adminHub: {
    title: "Admin",
    subtitle: "Where Darb stands, what it costs, and who may reach what.",
    tabDashboard: "Dashboard and forecast",
    tabPrices: "Prices",
    tabAccess: "Accounts and access",
    now: "Where we are now",
    forecast: "What to expect",
    activeVendors: "Shops",
    activeFleets: "Delivery companies",
    activeDrivers: "Active drivers",
    driversInTraining: "In training",
    ordersToday: "Orders today",
    deliveredToday: "Delivered today",
    revenueToday: "Delivery fees today",
    ...
    projectedRevenue: "Delivery fees, next 30 days",
    growth: "Week on week",
    basisLabel: "How this was worked out",
    notEnoughHistory: "Not enough history to forecast yet.",
    darbFees: "What Darb charges shops",
    darbFeesHint: "Delivery plans: by area, or by the kilometre.",
    fleetFees: "What Darb pays delivery companies",
    fleetFeesHint: "A base fee for each order, plus a rate for each kilometre.",
    openPricing: "Open the price lists",
    openFleets: "Open the delivery companies",
    openRateApprovals: "Rate changes waiting for approval",
    company: "Company",
    baseFee: "Base fee per order",
    perKm: "Per kilometre",
    flatOnly: "Flat rate",
    accessHint: "Roles, per-screen access, and which shops each account manager owns.",
    openPeople: "Open staff accounts",
    openVendors: "Open the shops",
    accountManagers: "Account managers",
    manages: "{n} shops",
    managesNone: "No shops assigned",
    staffAccounts: "Staff accounts",
    surfaces: "Screens",
  },
  vendorWallet2: {
    modeTitle: "How this shop's wallet works",
    modeSingle: "One wallet for the whole account",
    modeSingleHint: "Every branch spends from the same balance.",
    modePerBranch: "A wallet for each branch",
    modePerBranchHint: "Top up the main wallet, then move money to each branch yourself.",
    modeSaved: "Wallet setup saved",
    mainWallet: "Main wallet",
    branchWallet: "{name} wallet",
    available: "Available",
    allocated: "Moved in",
    spent: "Spent on deliveries",
    transfer: "Move money",
    transferTo: "Move to",
    transferBack: "Return to the main wallet",
    transferAmount: "Amount",
    transferNote: "Note",
    transferred: "Money moved",
    transfers: "Transfers",
    noTransfers: "No transfers yet.",
    statement: "Statement",
    statementFor: "Statement for {name}",
    mainStatementHint: "Top-ups, refunds and corrections. Deliveries belong to a branch.",
    insufficientMain: "The main wallet does not hold that much.",
    insufficientBranch: "That branch does not hold that much.",
...
export const ar: Messages = {
  ...
  errors: {
    ...
    savingData: "تعذر الحفظ. حاول مرة أخرى.",
    notFound: "غير موجود",
  ...
  hq: {
    ...
    admin: "الإدارة",
    opsTitle: "العمليات",
    opsSubtitle: "أرضية العمل، ومن عليها، ومن سينضم بعد ذلك.",
    tabLive: "مباشر",
    tabOrders: "الطلبات",
    tabEquipment: "المعدات",
    tabZones: "المناطق",
    tabDriverTracking: "متابعة المندوبين",
  ...
  driverTracking: {
    ...
    subtitle: "أداء كل مندوب، والمفاتيح التي تقرر ما إذا كان يعمل.",
    windowDays: "آخر {days} يوم",
    driver: "المندوب",
    ...
    sendToTraining: "إرسال للتدريب",
    frozen: "مجمد",
    inTraining: "قيد التدريب",
    freezeReason: "لماذا تجمد هذا المندوب؟",
    freezeReasonHint: "يرى المندوب وشركة التوصيل هذا السبب.",
    trainingPeriod: "مدة التدريب",
    days: "{n} أيام",
    oneDay: "يوم واحد",
    trainingReason: "لماذا ترسله للتدريب؟",
    sent: "تم الإرسال للتدريب",
    stateSaved: "تم تحديث المندوب",
    empty: "لا يوجد مندوبون مطابقون لهذه الفلاتر.",
  ...
  shiftPlan: {
    ...
    subtitle: "اقتراح مبني على ما حدث فعلا، لتعدله وتعتمده.",
    weekOf: "أسبوع {date}",
    generate: "إنشاء اقتراح",
    regenerate: "أعد البناء",
    approve: "اعتماد الخطة",
    discard: "تجاهل",
    statusDraft: "مسودة",
    statusApproved: "معتمد",
    statusDiscarded: "متجاهل",
    noPlan: "لا يوجد اقتراح لهذا الأسبوع بعد.",
    noPlanHint: "أنشئ واحدا وستقرأ دَرب الأسابيع الماضية لتقترح عدد المندوبين لكل فترة.",
    basis: "كيف تم حساب هذا",
    proposed: "المقترح",
    approved: "المعتمد",
    demand: "الطلبات في الأسابيع الماضية",
    zone: "المنطقة",
    window: "الفترة",
    save: "حفظ التغييرات",
    saved: "تم حفظ الخطة",
    approvedToast: "تم اعتماد الخطة. يحجز تطبيق المندوب عليها الآن.",
    approveWarning: "الاعتماد يستبدل كامل جدول السعة الذي يحجز عليه تطبيق المندوب.",
    approvedBy: "اعتمدها {name}",
    suggestedDrivers: "المندوبون المقترحون",
    noSuggestions: "لا يوجد مندوبون معينون لهذه المنطقة بعد.",
    readOnly: "هذا الأسبوع معتمد. أنشئ اقتراحا جديدا لتغييره.",
    weekAlreadyApproved: "تم اعتماد هذا الأسبوع بالفعل.",
  ...
  driverTraining: {
    ...
    subtitle: "طلبات تدريبية يوصلها المتدرب فعليا، تحت متابعتك، دون تحريك أي مبلغ.",
    newSession: "بدء فترة تدريب",
    statusScheduled: "مجدول",
    statusInProgress: "جارية",
    statusPassed: "اجتاز",
    statusFailed: "لم يجتز",
    statusCancelled: "ملغاة",
    period: "المدة",
    changePeriod: "تغيير المدة",
    ends: "تنتهي {date}",
    issueOrder: "إعطاء طلب تدريبي",
    pickupPoint: "الاستلام من",
    dropoffAddress: "التوصيل إلى",
    customerName: "اسم العميل",
    minutes: "الدقائق المسموحة",
    orders: "الطلبات التدريبية",
    noOrders: "لا توجد طلبات تدريبية بعد.",
    assigned: "المعطاة",
    deliveredCount: "الموصلة",
    failedCount: "الفاشلة",
    ...
    fail: "لم يجتز",
    cancel: "إلغاء",
    outcomeNote: "هل من ملاحظة؟",
    passHint: "الاجتياز يفعّل المندوب، ويبدأ التوزيع بعرض طلبات حقيقية عليه.",
    failHint: "يبقى غير مفعّل حتى يفعّله أحد.",
    empty: "لا توجد فترات تدريب بعد.",
    started: "تم فتح فترة التدريب",
    orderIssued: "تم إعطاء الطلب التدريبي",
    periodSaved: "تم تحديث المدة",
    completed: "تم إغلاق فترة التدريب",
    practiceBadge: "تدريبي",
    moneyNote: "الطلبات التدريبية لا تصل إلى السجل المالي أو لوحة المتجر أو مستحقات شركة التوصيل.",
    start: "ابدأ الآن",
  ...
  hqOnboarding: {
    title: "حسابات جديدة",
    subtitle: "متاجر وشركات توصيل وقّعها فريق المبيعات، بانتظار الإعداد.",
    add: "إضافة طلب",
    typeVendor: "متجر",
    typeFleet: "شركة توصيل",
    companyName: "اسم الشركة",
    companyNameAr: "الاسم بالعربية",
    code: "الرمز المختصر",
    codeHint: "يظهر في كل رقم طلب لهذا المتجر. حروف وأرقام، من 2 إلى 8.",
    ...
    reject: "رفض",
    rejectReason: "لماذا يتم رفض هذا؟",
    approveHint: "الاعتماد ينشئ الحساب. لا شيء موجود قبل ذلك.",
    created: "تمت إضافة الطلب",
    approvedToast: "تم إنشاء الحساب",
    rejectedToast: "تم رفض الطلب",
    empty: "لا يوجد شيء بالانتظار.",
    openAccount: "فتح الحساب",
    raisedBy: "أضافه {name}",
    codeInUse: "هذا الرمز مستخدم بالفعل. اختر رمزا آخر.",
    allTypes: "المتاجر والشركات",
  },
  compliance: {
    title: "الامتثال",
    subtitle: "المستندات خلف كل مندوب ومتجر وشركة توصيل في الشبكة.",
    tabDriverDocs: "مستندات المندوبين",
    tabRenewals: "جدول التجديد",
    tabPartnerDocs: "مستندات المتاجر والشركات",
    autoPass: "تم الفحص، لا ملاحظات",
    autoFlag: "ملاحظات من الفحص",
    autoPending: "لم يُفحص بعد",
    recheck: "أعد الفحص",
    approve: "اعتماد",
    reject: "رفض",
    rejectReason: "لماذا يتم رفض هذا؟",
    rejectHint: "تراه شركة التوصيل حرفيا.",
    requestDocument: "طلب مستند",
    requestNote: "ما الذي تحتاجه ولماذا؟",
    requestSent: "تم إرسال الطلب",
    statusREQUESTED: "مطلوب",
    statusPENDING_REVIEW: "بانتظارك",
    statusVALID: "سارٍ",
    statusREJECTED: "مرفوض",
    statusEXPIRED: "منتهٍ",
    ...
    viewFile: "فتح الملف",
    flaggedOnly: "الملاحظ فقط",
    empty: "لا يوجد شيء هنا.",
    approved: "تم اعتماد المستند",
    rejected: "تم رفض المستند",
    healthEXPIRED: "منتهٍ",
    healthEXPIRING: "يوشك على الانتهاء",
    healthVALID: "سارٍ",
    healthMISSING: "مفقود",
    daysLeft: "بقي {n} يوم",
    daysOverdue: "متأخر {n} يوم",
    freeze: "تجميد الحساب",
    unfreeze: "إلغاء التجميد",
    freezeReason: "لماذا يتم تجميد هذا الحساب؟",
    freezeHintDriver: "المندوب المجمد يتوقف عن استقبال الطلبات فورا.",
    freezeHintPartner: "يبقى الحساب مجمدا حتى يرفع الامتثال التجميد. لا يستطيع أهله ذلك.",
    frozen: "مجمد",
    ...
    scopeDRIVER: "مندوب",
    scopeCOMPANY: "شركة توصيل",
    scopeVENDOR: "متجر",
    checkNO_FILE: "لا يوجد ملف مرفق",
    checkNO_EXPIRY: "لم يُذكر تاريخ انتهاء",
    checkALREADY_EXPIRED: "منتهٍ بالفعل",
    checkEXPIRES_SOON: "ينتهي خلال 30 يوما",
    checkEXPIRY_IMPLAUSIBLE: "تاريخ الانتهاء يبدو غير صحيح",
    checkUNKNOWN_TYPE: "نوع المستند غير معروف",
    checkTYPE_MISMATCH: "نوع المستند لا يناسب صاحبه",
    checkFILE_TOO_SMALL: "الملف أصغر من أن يُقرأ",
    checkFILE_TOO_LARGE: "الملف أكبر من المسموح",
    checkUNSUPPORTED_FORMAT: "ليس صيغة مسح مستند",
    checkDUPLICATE_PENDING: "يوجد مستند آخر بنفس النوع بالانتظار",
    permissionDenied: "ليس لديك صلاحية الوصول إلى مكتب الامتثال.",
  },
  financeDesk: {
    ...
    account: "الحساب",
    kindVENDOR_TOP_UP: "شحن متجر",
    kindFLEET_DEPOSIT: "إيداع شركة",
    amount: "المبلغ",
    reference: "المرجع",
    requested: "تاريخ الطلب",
    confirm: "تأكيد الاستلام",
    cancelPayment: "إلغاؤه",
    rejectPayment: "رفضه",
    rejectReason: "لماذا يتم رفض هذا؟",
    confirmed: "تم تأكيد الدفعة",
    cancelled: "تم إلغاء الدفعة",
    alreadyPaid: "تم تأكيد هذه الدفعة مسبقا.",
    noPayments: "لا يوجد شيء بالانتظار.",
    showAll: "كل المدفوعات",
    showPending: "بالانتظار",
    sideAll: "المتاجر والشركات",
    sideVendor: "المتاجر",
    sideFleet: "شركات التوصيل",
    disputesTitle: "الاعتراضات",
    disputesSubtitle: "حيث يختلف معنا متجر أو شركة توصيل حول المال.",
    disputedStatement: "مستحقات معترض عليها",
    period: "الفترة",
    reason: "سببهم",
    openStatement: "فتح الكشف",
    noDisputes: "لا توجد اعتراضات مفتوحة.",
    reply: "رد",
    replyPlaceholder: "اكتب لهم",
    send: "إرسال",
  ...
  adminHub: {
    title: "الإدارة",
    subtitle: "أين تقف دَرب، وكم تكلف، ومن يصل إلى ماذا.",
    tabDashboard: "اللوحة والتوقعات",
    tabPrices: "الأسعار",
    tabAccess: "الحسابات والصلاحيات",
    now: "أين نحن الآن",
    forecast: "ما هو المتوقع",
    activeVendors: "المتاجر",
    activeFleets: "شركات التوصيل",
    activeDrivers: "مندوبون نشطون",
    driversInTraining: "قيد التدريب",
    ordersToday: "طلبات اليوم",
    deliveredToday: "موصلة اليوم",
    revenueToday: "رسوم التوصيل اليوم",
    ...
    projectedRevenue: "رسوم التوصيل، الـ30 يوما القادمة",
    growth: "أسبوعا بعد أسبوع",
    basisLabel: "كيف تم حساب هذا",
    notEnoughHistory: "لا يوجد سجل كافٍ للتوقع بعد.",
    darbFees: "ما تتقاضاه دَرب من المتاجر",
    darbFeesHint: "خطط التوصيل: حسب المنطقة أو حسب الكيلومتر.",
    fleetFees: "ما تدفعه دَرب لشركات التوصيل",
    fleetFeesHint: "رسم أساسي لكل طلب، بالإضافة إلى سعر لكل كيلومتر.",
    openPricing: "فتح قوائم الأسعار",
    openFleets: "فتح شركات التوصيل",
    openRateApprovals: "تغييرات الأسعار بانتظار الموافقة",
    company: "الشركة",
    baseFee: "الرسم الأساسي لكل طلب",
    perKm: "لكل كيلومتر",
    flatOnly: "سعر ثابت",
    accessHint: "الأدوار، والوصول لكل شاشة، والمتاجر التي يديرها كل مدير حساب.",
    openPeople: "فتح حسابات الموظفين",
    openVendors: "فتح المتاجر",
    accountManagers: "مدراء الحسابات",
    manages: "{n} متجر",
    managesNone: "لا توجد متاجر معينة",
    staffAccounts: "حسابات الموظفين",
    surfaces: "الشاشات",
  },
  vendorWallet2: {
    modeTitle: "كيف تعمل محفظة هذا المتجر",
    modeSingle: "محفظة واحدة للحساب كله",
    modeSingleHint: "كل فرع ينفق من نفس الرصيد.",
    modePerBranch: "محفظة لكل فرع",
    modePerBranchHint: "اشحن المحفظة الرئيسية، ثم انقل المبلغ إلى كل فرع بنفسك.",
    modeSaved: "تم حفظ إعداد المحفظة",
    mainWallet: "المحفظة الرئيسية",
    branchWallet: "محفظة {name}",
    available: "المتاح",
    allocated: "المحوّل إليها",
    spent: "المصروف على التوصيل",
    transfer: "نقل مبلغ",
    transferTo: "النقل إلى",
    transferBack: "الإرجاع إلى المحفظة الرئيسية",
    transferAmount: "المبلغ",
    transferNote: "ملاحظة",
    transferred: "تم نقل المبلغ",
    transfers: "التحويلات",
    noTransfers: "لا توجد تحويلات بعد.",
    statement: "كشف الحساب",
    statementFor: "كشف حساب {name}",
    mainStatementHint: "عمليات الشحن والاسترداد والتصحيح. التوصيلات تخص الفرع.",
    insufficientMain: "المحفظة الرئيسية لا تحتوي على هذا المبلغ.",
    insufficientBranch: "هذا الفرع لا يحتوي على هذا المبلغ.",
